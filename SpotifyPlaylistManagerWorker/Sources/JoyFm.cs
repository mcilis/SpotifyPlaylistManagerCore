...
namespace SpotifyPlaylistManagerWorker.Sources
{
    public class JoyFm
    {
        ...
        private readonly ILogger<JoyFm> _logger;
        private const string SourceServer = "JoyFmServer";

        public JoyFm(IHttpClientFactory httpClientFactory, IConfiguration configuration, ILogger<JoyFm> logger)
        {
        ...
        public async Task<string> GetCurrentSongAsync()
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, _configuration.GetValue("Source:JoyFm:RequestUri", ""));
